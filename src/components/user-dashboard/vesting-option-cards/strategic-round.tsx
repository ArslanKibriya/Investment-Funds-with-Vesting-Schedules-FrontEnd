            ...
            <div className={'ml_0 vesting-option-card'}>
                ...
                <FGrid className={'f-mt--3'}>
                    <FGridItem size={[6, 6, 6]} alignX="left">
                        <FTypo size={16} weight={400} color="#DAA961" className={"f-pb--2"}>
                            Allocation
                        </FTypo>
                ...
                <div>
                    <FTypo size={20} weight={400} color="#DAA961" className={"f-mt-2"}>
                        Vesting
                    </FTypo>
                ...
                {isInvest &&
                    <div>
                        <FTypo size={16} weight={400} color="#DAA961" className={"f-mt-3"}>
                            Amount to Invest
                        </FTypo>
                ...
                <div className={`d_flex justify_end align_center ${isInvest ? 'f-mt-1' : 'f-mt-4'}`}>
                    {isConnected ?
                        <FButton
                            className={`custom-font-size-14 font-700 border-radius-8 connectBtn ${isInvest ? 'bg_purple' : 'bg_white'}`}
